...
//        Debug.Log (GetType ().Name + "::OnSelectionChange");
    ...
    void ScaleParticleSystem (GameObject go, ParticleSystem ps)
    {
        ...
        so.FindProperty ("shape.radius").floatValue *= multiplier;
        so.FindProperty ("shape.length").floatValue *= multiplier;
        so.FindProperty ("shape.boxX").floatValue *= multiplier;
        so.FindProperty ("shape.boxY").floatValue *= multiplier;
        so.FindProperty ("shape.boxZ").floatValue *= multiplier;
        /*
